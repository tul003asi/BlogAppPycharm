...
def post_list_view(request,tag_slug=None):
    ...
    paginator = Paginator(post_list, 3)  # no.of.pages(20/2-rec=>10-pages)
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            #send_mail('Hello', 'Very imp msg....', 'tul003asi@gmail.com',['yamapoojitha2002@gmail.com', 'podagatlakavya@gmail.com'])
            sent=True
    else:
	    form=EmailSendForm()
